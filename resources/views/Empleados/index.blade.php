                    ...
                    <div class="modal-content">
                        ...
                        <form>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="nombre">Nombre</label>
                                    <input type="text" class="form-control" name="nombre" id="nombre"  placeholder="Ingrese el nombre" value="{{old('nombre', $empleado->nombre)}}" readonly>
                                    <small class="text-danger">{{$errors->first('nombre')}}</small>
                                </div>
                                <div class="form-group">
                                    <label for="edad">Edad</label>
                                    <input type="number" class="form-control" name="edad" id="edad"  placeholder="Ingrese su edad" value="{{old('edad', $empleado->edad)}}" readonly>
                                    <small class="text-danger">{{$errors->first('edad')}}</small>
                                </div>
                                <div class="form-group">
                                    <label for="direccion">Dirección</label>
                                    <textarea class="form-control" name="direccion" id="direccion" rows="2" readonly>{{old('direccion', $empleado->direccion)}}</textarea>
                                    <small class="text-danger">{{$errors->first('direccion')}}</small>

                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" class="form-control" id="email" name="email" placeholder="ingrese un email" value="{{old('email', $empleado->email)}}" readonly>
                                    <small class="text-danger">{{$errors->first('correo')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="cargo">Cargo</label>
                                    <input type="text" class="form-control" id="cargo" name="cargo" placeholder="ingrese un email" value="{{old('email', $empleado->cargoEmpleado->nombre)}}" readonly>
                                    <small class="text-danger">{{$errors->first('correo')}}</small>
                                </div>
                            </div>
                            <div class="modal-footer">
